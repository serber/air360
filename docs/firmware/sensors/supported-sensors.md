...
| Sensor type | Transport | Default binding | Detail doc |
|-------------|-----------|-----------------|------------|
| `BME280` | I2C | Bus 0, address `0x76` | [bme280.md](bme280.md) |
| `BME680` | I2C | Bus 0, address `0x77` | [bme680.md](bme680.md) |
| `SCD30` | I2C | Bus 0, address `0x61` | [scd30.md](scd30.md) |
| `SPS30` | I2C | Bus 0, address `0x69` | [sps30.md](sps30.md) |
| `VEML7700` | I2C | Bus 0, address `0x10` | [veml7700.md](veml7700.md) |
| `HTU2X` | I2C | Bus 0, address `0x40` | [htu2x.md](htu2x.md) |
| `SHT4X` | I2C | Bus 0, address `0x44` | [sht4x.md](sht4x.md) |
