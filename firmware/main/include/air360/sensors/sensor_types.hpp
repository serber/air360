...
inline const char* sensorValueKindKey(SensorValueKind kind) {
    switch (kind) {
        ...
        case SensorValueKind::kPowerMw:
            return "power_mw";
        case SensorValueKind::kDustConcentrationPcs001Cf:
...
inline const char* sensorTypeKey(SensorType type) {
    switch (type) {
        ...
        case SensorType::kSht3x:    return "sht3x";
        ...
        case SensorType::kScd40:    return "scd40";
        case SensorType::kScd41:    return "scd41";
        case SensorType::kIna226:   return "ina226";
