...
Subsystem identifiers in use: `app`, `backend_cfg`, `ble`, `cellular`, `cellular.cfg`, `config`, `connectivity`, `http`, `modem_gpio`, `net`, `power_gate`, `sensor`, `sensor_cfg`, `upload`, `web`.
...
See the full skill index and trigger table in [`../CLAUDE.md`](../CLAUDE.md).
